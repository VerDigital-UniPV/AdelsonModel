...
import module namespace edition = "http://www.edirom.de/xquery/edition" at "../../../../Edirom-Online/data/xqm/edition.xqm";

import module namespace eutil = "http://www.edirom.de/xquery/eutil" at "../../../../Edirom-Online/data/xqm/eutil.xqm";
...
let $xsl :=
    if ($xslInstruction) then
        ...
        ('xmldb:exist:///db/apps/Edirom-Online/data/xslt/tei/profiles/edirom-body/teiBody2HTML.xsl')
...
let $params := (
    ...
    <param name="base" value="{concat($base, '/../../../../Edirom-Online/data/xslt/')}"/>,
...
let $xsl := 'xmldb:exist:///db/apps/Edirom-Online/data/xslt/edirom_idPrefix.xsl'
